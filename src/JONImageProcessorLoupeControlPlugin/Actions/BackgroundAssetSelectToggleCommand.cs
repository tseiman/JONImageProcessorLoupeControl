namespace Loupedeck.JONImageProcessorLoupeControlPlugin
{
    ...
    public sealed class BackgroundAssetSelectToggleCommand : PluginMultistateDynamicCommand, IBlinkenLightsReceiver, IMultiWheelDispatchable, IMultiWheelUploadCompletedHandler
    {
        ...
        public BackgroundAssetSelectToggleCommand()
            : base(groupName: "Wheel Select", displayName: "Background Asset ON/OFF", description: "Enables background asset selection with the big multi wheel")
        {
            this.IsWidget = true;
            JONImageProcessorLoupeControlPlugin.PluginReady += this.OnPluginReady;

            this.AddState("OFF", "Background Asset\nOFF", "Background Asset ON");
            this.AddState("ON", "Background Asset\nON", "Background Asset ON");
        }
        ...
        private void OnPluginReady()
        {
            ...
            this._backgroundControl = ServiceDirectory.Get(ServiceDirectory.T_JonBackgroundControl) as JonBackgroundControl;
